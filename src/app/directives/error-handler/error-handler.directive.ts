...
export class ErrorHandlerDirective implements OnInit, OnDestroy {
  ...
  constructor(
    private readonly elementRef: ElementRef<MatError>,
  ...
  getErrorsObservable(errors: Observable<NullishValidationErrors> | Observable<NullishValidationErrors>[]): Observable<NullishValidationErrors[]> {
